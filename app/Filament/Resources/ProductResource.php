			...
			return $form
				->schema([
					Forms\Components\TextInput::make('name')
						...
						->columnSpan('full'),
					Forms\Components\FileUpload::make('try_on')
						->label('Ảnh thử mắt kính')
						->disk('public')
						->directory('uploads/')
					...
					Forms\Components\Select::make('material_id')
						->label('Chất liệu')
						->options(fn() => \App\Models\Material::pluck('name', 'id')
							->toArray())
						->required()
						->suffixAction(
					...
					Forms\Components\Select::make('origin_id')
						->label('Xuất xứ')
						->options(fn() => \App\Models\Origin::pluck('name', 'id')
							->toArray())
						->required()
						->suffixAction(
					...
					Forms\Components\Select::make('shape_id')
						->label('Kiểu dáng')
						->options(fn() => \App\Models\Shape::pluck('name', 'id')
							->toArray())
						->required()
						->suffixAction(
					...
					Forms\Components\Select::make('style_id')
						->label('Phong cách')
						->options(fn() => \App\Models\Style::pluck('name', 'id')
							->toArray())
						->required()
						->suffixAction(
