...
return [
    ...
    */
    ...
    'resource_permission_prefixes_labels' => [
        'view' => 'Xem',
        'view_any' => 'Xem tất cả', // "Xem nhiều" cũng là một lựa chọn
        'create' => 'Tạo',
        'update' => 'Cập nhật',
        'delete' => 'Xóa',
        'delete_any' => 'Xóa nhiều', // Hoặc "Xóa tất cả"
        'force_delete' => 'Xóa vĩnh viễn',
        'force_delete_any' => 'Xóa vĩnh viễn nhiều', // Hoặc "Xóa vĩnh viễn tất cả"
        'restore' => 'Khôi phục',
        'reorder' => 'Sắp xếp lại',
        'restore_any' => 'Khôi phục nhiều', // Hoặc "Khôi phục tất cả"
        'replicate' => 'Nhân bản',
    ],
];
