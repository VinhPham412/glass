...
<div class="max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($products as $product)
            <!-- Card -->
            <a href="{{route('shop.product_overview',$product->id)}}" class="group flex flex-col h-full bg-white border border-gray-200 shadow-md rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70 transition-transform duration-300 hover:shadow-lg hover:scale-105">
