                    ...
                    <div class="hidden md:block">
                        ...
                        <div class="relative">
                            ...
                            @if(!empty($searchInput))
                                <div class="absolute z-10 w-full mt-1 bg-white rounded-md shadow-lg dark:bg-neutral-800 " id="autocomplete-dropdown">
                                    <ul class="py-1 overflow-auto text-sm max-h-60">
                                        @forelse($list_product_search as $product)
                                        ...
                                        @empty
                                            <li class="px-4 py-2 hover:bg-gray-100 dark:hover:bg-neutral-700 cursor-pointer">Không có sản phẩm nào!!</li>
                                        @endforelse
                        ...
                        <!-- End Search Input with Autocomplete Dropdown -->
                    </div>
