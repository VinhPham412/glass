...
<!-- three.js r54 -->
<script src="{{asset('try_on/js/three.js')}}"></script>

<!-- clmtrack -->
<script src="{{asset('try_on/js/utils.js')}}"></script>
{{--<script src="{{asset('try_on/js/clmtrackr.js')}}"></script>--}}
...
<script>
    ...
    $(window).load(function () {
        ...
        var object = {
            outside: {
                left: '{{asset('try_on/glasses/left.png')}}',
                right: '{{asset('try_on/glasses/right.png')}}',
                front: '{{asset('try_on/glasses/front.png')}}',
            }
        };
